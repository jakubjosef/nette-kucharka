<?php //netteCache[01]000402a:2:{s:4:"time";s:21:"0.48031900 1367150428";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:80:"C:\wamp\www\eclipse\nette.sazkari\sandbox\app\templates\Sazkari\rozpiskola.latte";i:2;i:1367150399;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:30:"c0332ac released on 2013-03-08";}}}?><?php

// source file: C:\wamp\www\eclipse\nette.sazkari\sandbox\app\templates\Sazkari\rozpiskola.latte

?><?php
// prolog Nette\Latte\Macros\CoreMacros
list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, '54c9jtdthw')
;
// prolog Nette\Latte\Macros\UIMacros
//
// block menu
//
if (!function_exists($_l->blocks['menu'][] = '_lbd7e96d0634_menu')) { function _lbd7e96d0634_menu($_l, $_args) { extract($_args)
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb2707f08274_content')) { function _lb2707f08274_content($_l, $_args) { extract($_args)
?><fieldset>
    <legend>Rozpis ligy - <?php echo Nette\Templating\Helpers::escapeHtml($kolo->id, ENT_NOQUOTES) ?>. kolo</legend>
    <table>
            <thead>
                <tr>
...
"><?php echo Nette\Templating\Helpers::escapeHtml($kolo2->id, ENT_NOQUOTES) ?>. kolo </a></td>
<?php $iterations++; endforeach ?>
    ...
    <table>
            <thead>
            <tr>
                    <th colspan="2"><?php echo Nette\Templating\Helpers::escapeHtml($kolo->id, ENT_NOQUOTES) ?> kolo</th>
