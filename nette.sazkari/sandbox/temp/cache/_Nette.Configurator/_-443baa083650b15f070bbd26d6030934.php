<?php //netteCache[01]000406a:2:{s:4:"time";s:21:"0.33389100 1364988308";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:65:"/storage/emulated/legacy/www/nette/sandbox/app/config/config.neon";i:2;i:1364988150;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:71:"/storage/emulated/legacy/www/nette/sandbox/app/config/config.local.neon";i:2;i:1364988150;}}}?><?php
// source: /storage/emulated/legacy/www/nette/sandbox/app/config/config.neon production
// source: /storage/emulated/legacy/www/nette/sandbox/app/config/config.local.neon 

/**
 * @property Todo\AdminRepository $adminRepository
 ...
 * @property Todo\NovinkyRepository $novinkyRepository
...
class SystemContainer extends Nette\DI\Container
{
	...
	public $classes = array(
		'nette\\object' => FALSE, //: nette.cacheJournal, cacheStorage, nette.httpRequestFactory, httpRequest, httpResponse, nette.httpContext, session, nette.userStorage, user, application, nette.mailer, nette.database, novinkyRepository, adminRepository, listRepository, taskRepository, userRepository, authenticator, container,
		...
		'todo\\repository' => FALSE, //: novinkyRepository, adminRepository, listRepository, taskRepository, userRepository,
		'todo\\novinkyrepository' => 'novinkyRepository',
		'routerfactory' => 'routerFactory',
		'todo\\adminrepository' => 'adminRepository',
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/storage/emulated/legacy/www/nette/sandbox/app',
			'wwwDir' => '/mnt/sdcard/www/nette/sandbox/www',
			'debugMode' => FALSE,
			'productionMode' => TRUE,
			...
			'tempDir' => '/storage/emulated/legacy/www/nette/sandbox/app/../temp',
		));
	}


	/**
	 * @return Todo\AdminRepository
	 */
	protected function createServiceAdminRepository()
	{
		$service = new Todo\AdminRepository($this->getService('nette.database.default'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/storage/emulated/legacy/www/nette/sandbox/app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/storage/emulated/legacy/www/nette/sandbox/app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=localhost;dbname=sazkari', 'root', NULL, NULL);
	...
	{
		$service = new Nette\Application\PresenterFactory('/storage/emulated/legacy/www/nette/sandbox/app', $this);
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('/storage/emulated/legacy/www/nette/sandbox/app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	/**
	 * @return Todo\NovinkyRepository
	 */
	protected function createServiceNovinkyRepository()
	{
		$service = new Todo\NovinkyRepository($this->getService('nette.database.default'));
		return $service;
	}
